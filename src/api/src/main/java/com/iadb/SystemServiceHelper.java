...
public class SystemServiceHelper {
     ...
     * @deprecated Use {@link IadbBinderWrapper} instead
     */
    @Deprecated
    ...
    /**
     * Obtain a new data parcel for {@link Iadb#transactRemote(Parcel, Parcel, int)}.
     *
    ...
    public static Parcel obtainParcel(@NonNull String serviceName, @NonNull String interfaceName, @NonNull String className, @NonNull String methodName) {
        throw new UnsupportedOperationException("Direct use of Iadb#transactRemote is no longer supported, please use IadbBinderWrapper");
    }
}
